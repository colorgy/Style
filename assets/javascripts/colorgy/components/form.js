// Originally from https://github.com/mkhairi/materialize-sass/blob/7784a51b70881dd5cc7dd35549eeabf9ad03b3bb/app/assets/javascripts/materialize/forms.js
...
(function ($) {
  $(document).ready(function() {
    ...
    var hiddenDiv = $('.textarea-autosize-hiddendiv').first();
    if (!hiddenDiv.length) {
      hiddenDiv = $('<div class="textarea-autosize-hiddendiv common"></div>');
      $('body').append(hiddenDiv);
    }
    var text_area_selector = 'textarea.autosize';
